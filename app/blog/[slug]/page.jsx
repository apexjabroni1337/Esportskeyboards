...
const ARTICLES = {
  ...
  "rapid-trigger-actuation-explained": {
    ...
    content: () => [
      ...
      { type: "p", text: "eDPI (effective DPI) = DPI × In-game Sensitivity. This is the number that actually matters for comparing settings between players. A player at 400 DPI with 2.0 sensitivity has 800 eDPI — identical to a player at 800 DPI with 1.0 sensitivity." },
