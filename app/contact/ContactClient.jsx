...
export default function ContactClient() {
    ...
    try {
      const res = await fetch(`https://formspree.io/f/${FORMSPREE_ID}`, {
        ...
        body: JSON.stringify({
          ...
          _subject: `[EsportsKeyboards] ${form.subject === "correction" ? "Data Correction" : form.subject === "feature" ? "Feature Request" : form.subject === "partnership" ? "Partnership Inquiry" : "General"}: from ${form.name}`,
        }),
      });
  ...
  const subjects = [
    ...
    { value: "correction", label: "Data Correction", icon: I.bug, desc: "Wrong keyboard, player info, or stats" },
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-5">
              ...
              <textarea required rows={6} value={form.message} onChange={e => setForm({ ...form, message: e.target.value })}
                placeholder={form.subject === "correction" ? "Which player/keyboard has incorrect data? What should it be?" : form.subject === "feature" ? "Describe the feature or tool you'd like to see..." : form.subject === "partnership" ? "Tell us about your brand or organization and what you have in mind..." : "What's on your mind?"}
