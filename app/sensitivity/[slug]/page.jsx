...
const GAME_SENS_INFO = {
  ...
  "LoL": { fullName: "League of Legends", sensMultiplier: null, unit: "Windows DPI", example: "800-1600 DPI", notes: "League of Legends does not have an in-game sensitivity slider in the same way FPS games do. Mouse speed is controlled primarily through DPI and Windows pointer speed. Most LoL pros use 800-1600 DPI." },
