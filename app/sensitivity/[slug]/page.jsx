...
const GAME_SENS_INFO = {
  ...
  "LoL": { fullName: "League of Legends", sensMultiplier: null, unit: "Windows DPI", example: "800-1600 DPI", notes: "League of Legends does not have an in-game sensitivity slider in the same way FPS games do. Cursor speed is controlled primarily through DPI and Windows pointer speed. Most LoL pros use 800-1600 DPI." },
  "Dota 2": { fullName: "Dota 2", sensMultiplier: null, unit: "Windows DPI", example: "800-1200 DPI", notes: "Like League of Legends, Dota 2 cursor speed is primarily DPI-based. Most Dota 2 pros use 800-1200 DPI. Camera movement and precision clicking are more relevant than aiming sensitivity." },
...
export function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: `https://esportskeyboards.com/og?title=${encodeURIComponent(info.fullName + ' Sensitivity')}&subtitle=${encodeURIComponent(`${players.length} Pro Players · Avg eDPI ${avgEdpi} · DPI Calculator`)}`, width: 1200, height: 630 }],
    },
  ...
  return (
    <>
      ...
      >
        ...
        <table>
          <caption>Professional {info.fullName} player sensitivity, DPI and keyboard settings</caption>
          <thead><tr><th>Player</th><th>Team</th><th>Keyboard</th><th>DPI</th><th>Sensitivity</th><th>eDPI</th></tr></thead>
          <tbody>
            {topPlayers.map((p, i) => (
              <tr key={i}>
