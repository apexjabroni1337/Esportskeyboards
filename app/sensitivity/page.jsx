...
export const metadata = {
  ...
  openGraph: {
    ...
    url: "https://esportskeyboards.com/sensitivity",
    images: [{ url: "https://esportskeyboards.com/og?title=Sensitivity+Converter&subtitle=CS2+%C2%B7+Valorant+%C2%B7+Fortnite+%C2%B7+Apex+%C2%B7+cm%2F360+%C2%B7+Pro+Comparison", width: 1200, height: 630 }],
  },
  twitter: {
...
export default function SensitivityPage() {
  ...
  return (
    <>
      ...
      >
        <h1>Keyboard Sensitivity Converter — Convert Settings Between Esports Games</h1>
        <p>
