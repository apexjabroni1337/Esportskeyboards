...
const BRAND_DESCRIPTIONS = {
  Razer: "Razer is one of the world's largest gaming peripherals companies and a dominant force in esports keyboards. Founded in 2005, Razer has built its reputation on aggressive innovation, from the original DeathAdder that became an esports icon to the Viper V3 Pro that currently leads the pro scene. Razer keyboards are known for their Focus Pro sensors, lightweight designs, and the distinctive green-and-black branding that is instantly recognizable in any gaming setup. The Viper series revolutionized competitive gaming with its symmetrical low-profile shape, while the DeathAdder remains the most popular ergonomic keyboard layout in esports history. Razer's investment in professional esports sponsorships has made their keyboards the most commonly seen brand on tournament stages worldwide.",
  ...
  Zowie: "Zowie, a division of BenQ, built its legendary reputation in esports by focusing entirely on what competitive players need: perfect shapes, reliable sensors, and no unnecessary features. The EC series is widely considered the greatest ergonomic keyboard layout ever designed for gaming, and the FK series set the standard for low-profile ambidextrous keyboards. Zowie's philosophy of plug-and-play simplicity — no software required, adjustable DPI via a button on the bottom — resonated deeply with the professional CS community. While other brands chased RGB lighting and wireless technology, Zowie refined their shapes over generations. Their recent wireless entries like the EC-CW and the s1mple-influenced donk edition show the brand evolving while maintaining the shape legacy that made them icons.",
  Finalmouse: "Finalmouse pioneered the ultralight keyboard revolution that reshaped the entire gaming peripherals industry. When they released the Ultralight Pro at 67 grams in 2018, it was considered impossibly light — now every major brand builds sub-60g keyboards. Finalmouse's limited-edition drop model and provocative marketing have made them one of the most polarizing brands in gaming, but their influence on keyboard design is undeniable. The Air58, Ultralight 2 Cape Town, Starlight-12, and UltralightX each pushed boundaries in weight reduction and design. Their collaboration with Ninja on the Air58 became one of the most sought-after peripherals in gaming history. Finalmouse keyboards command premium prices and sell out instantly, creating a collector's market alongside their competitive credentials.",
